...
Node::Node(std::shared_ptr<Node> node0, std::shared_ptr<Node> node1){
    this->node0 = node0;
    this->node1 = node1;
...
void Node::setNode0(std::shared_ptr<Node> node0){
    this->node0 = node0;
}
void Node::setNode1(std::shared_ptr<Node> node1){
    this->node1 = node1;
}
int Node::getValue0(){
    return value0;
...
std::shared_ptr<Node> Node::getNode0(){
    return node0;
}
std::shared_ptr<Node> Node::getNode1(){
    return node1;
}
